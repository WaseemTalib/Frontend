      ...
      <div className="add_content">
        ...
        <div className="content">
          <div className="content_inner">
            <div className="add_content_wrapper" style={{ textAlign: `center`, marginBottom: `50px`, width: "30%" }}>
            ...
            <div className="input_content_wrapper">
              ...
              <p className="mb-5">
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", borderRadius: "3px",margin: "0 auto", width: "max-content", border: "1px solid #ced4da" }} >
                <img  htmlFor="bookpdf" src="https://cdn4.iconfinder.com/data/icons/file-extension-names-vol-8/512/24-512.png" width="50px" height="50px" />
                  <label style={{ cursor: "pointer", width: "auto", margin: "0" }}> <div style={{fontFamily:"cursive", fontSize: "1.2rem", color: "gray" }}> No File selected </div>
